...
plot.ts(posterior.ext$A.posterior.exten[2,1,], xlab = "Simulation times S", ylab = "AUD/USD exchange rate.exten", col = mcxs1)   
hist(posterior.ext$A.posterior.exten[2,1,], xlab = "AUD/USD exchange rate.exten", col = mcxs1, main = '')
...
$\Omega=diag(e^{h_1}\lambda_1,e^{h_2}\lambda_2,...,e^{h_T}\lambda_t)$, represent as:
